...
<div class="card mb-6">
    <div class="p-6">
        ...
        <div class="grid gap-6">
            <div>
                <form method="POST" action="{{ route('dinasan.update', $dinasan->slug) }}">
                    @method('put')
                    @csrf

                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        <label class="mb-2" for="nama">Dinas <span class="text-danger">*</span></label>
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $dinasan->nama) }}" class="form-input">
                            @error('nama')

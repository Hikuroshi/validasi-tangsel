...
<div class="card mb-6">
    <div class="p-6">
        ...
        <div class="grid xl:grid-cols-2 gap-6">
            <div>
                <form method="POST" action="{{ route('jenis-pekerjaan.update', $jenis_pekerjaan->slug) }}">
                    @method('put')
                    @csrf
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="jenis" name="jenis" class="form-select">
                                ...
                                <option value="{{ $jenis }}" @selected(old('jenis', $jenis_pekerjaan->jenis) == $jenis)>
                                    {{ $jenis }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-start justify-between">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('jenis-pekerjaan.index') }}" class="btn bg-secondary/90 text-white hover:bg-secondary text-end">Kembali</a>

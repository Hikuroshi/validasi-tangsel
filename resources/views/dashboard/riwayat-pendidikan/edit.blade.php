                ...
                <form method="POST" action="{{ route('riwayat-pendidikan.update', $riwayat_pendidikan->slug) }}">
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $riwayat_pendidikan->nama) }}" class="form-input">
                            @error('nama')
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="jurusan" name="jurusan" value="{{ old('jurusan', $riwayat_pendidikan->jurusan) }}" class="form-input">
                            @error('jurusan')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="gelar" name="gelar" value="{{ old('gelar', $riwayat_pendidikan->gelar) }}" class="form-input">
                            @error('gelar')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="number" id="thn_masuk" name="thn_masuk" value="{{ old('thn_masuk', $riwayat_pendidikan->thn_masuk) }}" class="form-input" min="1901" max="{{ now()->format('Y') }}" step="1">
                            @error('thn_masuk')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="number" id="thn_lulus" name="thn_lulus" value="{{ old('thn_lulus', $riwayat_pendidikan->thn_lulus) }}" class="form-input" min="1901" max="{{ now()->format('Y') }}" step="1">
                            @error('thn_lulus')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="ijazah" name="ijazah" value="{{ old('ijazah', $riwayat_pendidikan->ijazah) }}" class="form-input">
                            @error('ijazah')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>

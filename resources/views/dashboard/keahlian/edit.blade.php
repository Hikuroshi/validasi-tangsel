                ...
                <form method="POST" action="{{ route('keahlian.update', $keahlian->slug) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $keahlian->nama) }}" class="form-input">
                            @error('nama')
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="no_sertifikat" name="no_sertifikat" value="{{ old('no_sertifikat', $keahlian->no_sertifikat) }}" class="form-input">
                            @error('no_sertifikat')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="number" id="thn_sertifikat" name="thn_sertifikat" value="{{ old('thn_sertifikat', $keahlian->thn_sertifikat) }}" class="form-input" min="1901" max="{{ now()->format('Y') }}" step="1">
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="file" id="file_sertifikat" name="file_sertifikat" accept="application/pdf" class="form-input border">

                ...
                <form method="POST" action="{{ route('perusahaan.update', $perusahaan->slug) }}">
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $perusahaan->nama) }}" class="form-input" placeholder="Nama">
                            @error('nama')
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="npwp" name="npwp" value="{{ old('npwp', $perusahaan->npwp) }}" class="form-input" placeholder="NPWP">
                            @error('npwp')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="telepon" name="telepon" value="{{ old('telepon', $perusahaan->telepon) }}" class="form-input" placeholder="Telepon">
                            @error('telepon')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="email" id="email" name="email" value="{{ old('email', $perusahaan->email) }}" class="form-input" placeholder="Email">
                            @error('email')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-start justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <textarea id="alamat" name="alamat" class="form-input" rows="5" placeholder="Alamat">{{ old('alamat', $perusahaan->alamat) }}</textarea>
                            @error('alamat')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>

...
<div class="card mb-6">
    <div class="p-6">
        ...
        <div class="grid xl:grid-cols-2 gap-6">
            <div>
                <form method="POST" action="{{ route('kecamatan.update', $kecamatan->slug) }}">
                    @method('put')
                    @csrf
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $kecamatan->nama) }}" class="form-input" placeholder="Nama">
                            @error('nama')

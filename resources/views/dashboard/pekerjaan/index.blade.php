        ...
        basicTableInit(pekerjaans) {
            if (document.getElementById("table-gridjs")) {
                new gridjs.Grid({
                    ...
                    "Metode Pengadaan",
                    {
                        ...
                        formatter: (cell, row) => {
                            return gridjs.html(`<div class="flex flex-wrap items-center gap-1">
                                <a class="inline-flex items-center gap-1.5 py-0.5 px-1.5 rounded text-xs font-medium bg-primary text-white" href="/dashboard/pekerjaan/${cell}">
                                    <i class="uil uil-eye"></i>
                                </a>
                                <a class="inline-flex items-center gap-1.5 py-0.5 px-1.5 rounded text-xs font-medium bg-info text-white" href="/dashboard/pekerjaan/${cell}/edit">
                                    <i class="uil uil-pen"></i>
                                </a>
                                <form action="/dashboard/pekerjaan/${cell}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                    ...
                    index + 1,
                    pekerjaan.nama,
                    pekerjaan.nilai_kontrak_f,
                    pekerjaan.lokasi,
                    pekerjaan.sumber_dana,
                    pekerjaan.thn_anggaran,
                    pekerjaan.metode.nama,
                    pekerjaan.slug,
                    ]),

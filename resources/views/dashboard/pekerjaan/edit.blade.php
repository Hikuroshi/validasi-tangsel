                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="bidang_id" name="bidang_id" class="form-select">
                                ...
                                <option value="{{ $bidang->id }}" @selected(old('bidang_id', $pekerjaan->bidang_id) == $bidang->id)>
                                    {{ $bidang->nama }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="jenis_pekerjaan_id" name="jenis_pekerjaan_id" class="form-select">
                                ...
                                <option value="{{ $jenis_pekerjaan->id }}" @selected(old('jenis_pekerjaan_id', $pekerjaan->jenis_pekerjaan_id) == $jenis_pekerjaan->id)>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="thn_anggaran" name="thn_anggaran" class="form-select">
                                <option></option>
                                <option value="2024" @selected(old('thn_anggaran', $pekerjaan->thn_anggaran) == 2024)>2024</option>
                            </select>
                            @error('thn_anggaran')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror

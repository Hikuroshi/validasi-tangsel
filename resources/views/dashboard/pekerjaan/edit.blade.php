            ...
            <div class="col-span-2">
                <form method="POST" action="{{ route('pekerjaan.update', $pekerjaan->slug) }}">
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $pekerjaan->nama) }}" class="form-input" placeholder="Nama Pekerjaan">
                            @error('nama')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-start justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <textarea id="deskripsi" name="deskripsi" class="form-input" rows="5" placeholder="Deskripsi">{{ old('deskripsi', $pekerjaan->deskripsi) }}</textarea>
                            @error('deskripsi')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="kecamatan_id" name="kecamatan_id" class="form-select">
                                ...
                                <option value="{{ $kecamatan->id }}" @selected(old('kecamatan_id', $pekerjaan->kecamatan_id) == $kecamatan->id)>
                                    {{ $kecamatan->nama }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-start justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <textarea id="lokasi" name="lokasi" class="form-input" rows="5" placeholder="Lokasi">{{ old('lokasi', $pekerjaan->lokasi) }}</textarea>
                            @error('lokasi')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="sumber_dana" name="sumber_dana" value="{{ old('sumber_dana', $pekerjaan->sumber_dana) }}" class="form-input" placeholder="Sumber Dana">
                            @error('sumber_dana')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="number" id="thn_anggaran" name="thn_anggaran" value="{{ old('thn_anggaran', $pekerjaan->thn_anggaran) }}" class="form-input" placeholder="Tahun Anggaran" min="1901" max="{{ now()->format('Y') }}" step="1">
                            @error('thn_anggaran')
                            <p class="inline-block text-danger"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <select id="metode_id" name="metode_id" class="form-select">
                                ...
                                <option value="{{ $metode->id }}" @selected(old('metode_id', $pekerjaan->metode_id) == $metode->id)>
                                    {{ $metode->nama }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between">
                        ...
                        <div class=" w-full sm:w-5/6">
                            <input type="text" id="jenis_kontruksi" name="jenis_kontruksi" value="{{ old('jenis_kontruksi', $pekerjaan->jenis_kontruksi) }}" class="form-input" placeholder="Jenis Kontruksi">

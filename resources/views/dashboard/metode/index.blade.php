                    ...
                    { name: "No", formatter: function (e) { return gridjs.html('<span class="font-semibold">' + e + "</span>") } },
                    {
                        ...
                        formatter: (cell, row) => {
                            return gridjs.html(`<div class="flex flex-wrap items-center gap-1">
                                <a class="inline-flex items-center gap-1.5 py-0.5 px-1.5 rounded text-xs font-medium bg-info text-white" href="/metode/${cell}/edit">
                                    <i class="uil uil-pen"></i>
                                </a>
                                <form action="/metode/${cell}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
